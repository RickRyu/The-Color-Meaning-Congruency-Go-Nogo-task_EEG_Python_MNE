...
plt.rcParams['font.size'] = 20  # 원하시는 글씨 크기로 설정하세요
...
# 선택할 이벤트 목록
selected_events = ['Condition 2 - Green Go', 'Condition 2 - Red Stop', 'Condition 2 - Red Go', 'Condition 2 - Green Stop']
